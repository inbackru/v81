    ...
    async loadFavoritesFromAPI() {
        ...
        try {
            ...
            if (complexResult.success && complexResult.complexes && complexResult.complexes.length > 0) {
                ...
                console.log('🔥 Loaded complex favorites from API (complexes):', this.favoriteComplexes);
                ...
                console.log('🔥 Loaded complex favorites from API (favorites):', this.favoriteComplexes);
            }
